...
- date_of_birth: Date of birth in YYYY-MM-DD format (optional)"`;
      ...
      csvContent = `full_name,email,staff_id,password,subject,phone,date_of_birth,address,status
Mrs. Adebayo,adebayo@teacher.school,TCH001,Teacher@123,Mathematics,+234 802 345 6789,1975-06-20,Lagos, Nigeria,active
Mr. Johnson,johnson@teacher.school,TCH002,Teacher@124,English,+234 803 456 7890,1978-09-15,Abuja, Nigeria,active
Dr. Okonkwo,okonkwo@teacher.school,TCH003,Teacher@125,Physics,+234 804 567 8901,1972-12-03,Port Harcourt, Nigeria,active
"Instructions:
...
- date_of_birth: Date of birth in YYYY-MM-DD format (optional)
- address: Teacher address (optional)
